...
public final class Vector {
  ...
  public static Direction reflect(Direction incoming, Direction normal) {
    double dot = dotProduct(incoming, normal);
    return subtract(incoming, multiply(2 * dot, normal));
}
  ...
  public static final Color violet = color(0.7,0,0.7);
}
